      ...
      <div className="contact-container">
        ...
        <div className="contact-iconBox">
          <div className="contact-phoneBox">
            ...
            <a href="tel:010-7542-2441"><FaMobileAlt size="25" /></a>
            </div>
            <div className="contact-detail">+82 010-7542-2441</div>
          </div>
          <div className="contact-mailBox">
            <div className="contact-mail">
            <a href="mailto:jin0201948@gmail.com"><FaRegEnvelope size="25" /></a>
            </div>
          ...
          <div className="contact-gitBox">
            <div className="contact-git">
              <a href="https://github.com/Nohkii" target='_blank' rel='noreferrer'><GoMarkGithub size="25" /></a>
            </div>
